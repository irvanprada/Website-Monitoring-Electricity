			...
			<div id="wrapper" class="tooltips">
				...
				<div id="page-wrapper" class="white-bg">
					<div class="row border-bottom">
						<nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
							...
							<div class="col-lg-7 col-xs-3">
								<div style="text-align:center; margin-top:22px;">
									<h4><strong>TA TE 2109/2020</strong></h4>
								</div>
							</div>
						...
						<div class="row border-top white-bg" style="margin-left:2px;">
							<div class="pull-left" style="padding-left:20px">
								<table class="table" style="margin-bottom: 0; border-style:hidden;">
					...
					<div id="app" class="row white-bg" style="padding:10px; padding-bottom:40px;">
						<div style="padding-left:1px">
							<table id="app" class="table table-striped table-bordered table-sm" cellspacing="0" aria-multiselectable="false" style="width: 150%;">
								<thead>
									<tr style="border: 1px solid #f5f5f6; background: #f5f5f6; ">
										<th style="border: 1px solid #b6b6b6;  text-align: center;">Tanggal</th>
										<th style="border: 1px solid #b6b6b6;  text-align: center;">Daya</th>
										<th style="border: 1px solid #b6b6b6;  text-align: center;">Arus</th>
									</tr>
								</thead>
								<?php
								$count = 0;
								...
								<tr type="checkbox" class="success" role="row" aria-selected="false">
									...
									<td title="<?php echo $row->Tanggal ?>" style="solid #b6b6b6;  text-align: center"><?php echo $row->Tanggal; ?></td>
									<td title="<?php echo $row->Daya ?>" style=" solid #b6b6b6;  text-align: center"><?php echo $row->Daya; ?></td>
									<td title="<?php echo $row->Arus ?>" style=" solid #b6b6b6; word-wrap: break-word;  text-align: center"><?php echo $row->Arus; ?></td>
